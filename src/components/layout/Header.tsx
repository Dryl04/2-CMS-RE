...
import { Layout, LogOut, User, FileText, Image, TrendingUp, Paintbrush, Menu, X, Sparkles, Link2, PenLine } from 'lucide-react';
...
const NAV_ITEMS = [
  ...
  { key: 'redaction', label: 'Rédaction', icon: PenLine },
