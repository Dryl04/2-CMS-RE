...
| `DELETE` | `/api/pages/:id`              | JWT + editor roles | Delete a page                                              |
...
| `DELETE` | `/api/templates/:id` | JWT + editor roles |
...
| `POST`   | `/api/themes/daisy`     | JWT + editor roles |
| `PATCH`  | `/api/themes/daisy/:id` | JWT + editor roles |
| `DELETE` | `/api/themes/daisy/:id` | JWT + editor roles |
| `GET`    | `/api/fonts`            | JWT                |
| `POST`   | `/api/fonts`            | JWT                |
| `DELETE` | `/api/fonts/:id`        | JWT + editor roles |
...
| `DELETE` | `/api/redirects/:id` | JWT + editor roles |
...
| `POST`   | `/api/global-hf`     | JWT + editor roles |
| `PATCH`  | `/api/global-hf/:id` | JWT + editor roles |
| `DELETE` | `/api/global-hf/:id` | JWT + editor roles |
