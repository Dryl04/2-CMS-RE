...
test('convertJsonbUuidArrayValue converts jsonb arrays and NULL to uuid[] literals', () => {
  assert.equal(convertJsonbUuidArrayValue(`'["a","b"]'::jsonb`), `ARRAY['a', 'b']::uuid[]`);
...
test('transformGlobalHfSettingsInsert rewrites target_page_ids to uuid[]', () => {
  ...
  assert.match(output, /ARRAY\['11111111-1111-1111-1111-111111111111', '22222222-2222-2222-2222-222222222222'\]::uuid\[\]/);
});
